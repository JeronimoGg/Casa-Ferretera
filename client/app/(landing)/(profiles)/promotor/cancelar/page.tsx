...
import { CancelPromotoriasPromotor } from "@/components/card/cancelarPromotoriasPromotor";
...
const CancelarProveedor = () => {
    ...
    const getPromotorias = async () => {
      try {
        ...
        const response = await fetch('/api/promotorias/cancelar-promotor',{
          method: 'GET',
          headers: {
