...
import SignUpSupervisor from "@/components/formulario/agregarSupervisor";
...
const CrearSupervisor = () => {
    ...
    return(
        <LayoutProfile titulo={titulo}> 
            <h1 className="text-center pt-5 font-bold text-3xl">Esta creando un nuevo supervisor</h1>
            <SignUpSupervisor />
        </LayoutProfile>
    )
}
